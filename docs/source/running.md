...
1. **Google Colab Notebook:** (run remotely on free google cloud resources)
    * *Both an 'easy' and 'manual' run mode is available for users to apply STREAMLINE to their own data*
...
effectively the same for running STREAMLINE from Jupyter Notebook.
