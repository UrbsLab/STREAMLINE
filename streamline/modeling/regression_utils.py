...
# Load regression model classes from the specified folder
SUPPORTED_REGRESSION_MODELS_OBJ = load_class_from_folder(model_type="Regression")

# Extract model names, small names, and color lists for regression models
...
# Create dictionaries mapping model names to model objects and vice versa
...
# Helper function to convert a model name to its corresponding model object
