...
# Load both binary classification and regression model classes from the specified folders
SUPPORTED_MODELS_OBJ = load_class_from_folder(model_type="BinaryClassification") \
                       + load_class_from_folder(model_type="Regression")

# Extract model names, small names, and color lists for all supported models
