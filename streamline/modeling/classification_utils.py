...
# Determine the number of cores to use, either from the SLURM_CPUS_PER_TASK environment variable or the total CPU count
num_cores = int(os.environ.get('SLURM_CPUS_PER_TASK', multiprocessing.cpu_count()))

# Load all supported binary classification models
