...
class TabPFNRegressor(RegressionModel, ABC):
    ...
    def __init__(
        ...
        ensemble_param = tabpfn_ensemble_param(_TabPFNRegressor)
        ...
        self._base_params = supported_kwargs(_TabPFNRegressor, self._base_params)
    ...
    def objective(self, trial, params: Dict[str, Any] | None = None):
        ...
        cand2 = supported_kwargs(_TabPFNRegressor, cand2)
        cand = cand2

        cand["device"] = "cpu"
        cand = supported_kwargs(_TabPFNRegressor, cand)
