...
* optuna (v_2.10.0) Optuna, a hyperparameter optimization framework
...
| --n-trials | # of bayesian hyperparameter optimization trials using optuna | 200 |
| --timeout | seconds until hyperparameter sweep stops running new trials (Note: it may run longer to finish last trial started) | 900 |
