...
The current v1.0.1 pipeline has eleven phases. P1-P8 are the core training and
...
P7 is classification-only in the current v1.0.1 implementation. Regression
